{-# LANGUAGE Safe, CPP, FlexibleInstances #-}
...
--class (Monad m) => MPrintfType (m String) where
--    mspr :: Handle -> String -> [UPrintf] -> m String
...
instance PrintfType (Maybe String) where
    spr fmts args =
        Just $ uprintf fmts $ reverse args
